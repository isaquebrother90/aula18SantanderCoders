...
public class ContatosTest {
		...
		static List<Contatos> contatos = new ArrayList<Contatos>();
		...
		static public void addContato() {
			...
			Contatos c = new Contatos(id, name, age, phone, new Endereco(street, number, burgh, city, state));
			contatos.add(c);
